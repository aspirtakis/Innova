...
import makeSelectVotingForm from "./selectors";
...
export function VotingForm() {
  useInjectReducer({ key: "votingForm", reducer });
  useInjectSaga({ key: "votingForm", saga });
...
const mapStateToProps = createStructuredSelector({
  votingForm: makeSelectVotingForm()
});
...
export default compose(withConnect)(VotingForm);
