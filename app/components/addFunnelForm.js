          ...
          {getFieldDecorator('status', {
            ...
            <Select key={5} placeholder="Status" style={{ width: 150 }}>
              ...
              <Option value="yellow">
                <div style={{ flex: 1 }}>
                  IMPEDIMENT{' '}
                  <Icon style={{ marginLeft: 3, color: 'yellow' }} type="login" />
                </div>
              </Option>
              <Option value="orange">
                <div style={{ flex: 1 }}>
                  PARKED <Icon style={{ marginLeft: 3,color: 'orange' }} type="login" />
                </div>
              </Option>
              <Option value="red">
                <div style={{ flex: 1 }}>
                  STOPPED <Icon style={{ marginLeft: 3, color: 'red' }} type="login" />
                </div>
              </Option>
            </Select>,
          )}
